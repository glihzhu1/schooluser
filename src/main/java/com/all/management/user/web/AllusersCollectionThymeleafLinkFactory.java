...
@Component
/**
 * = AllusersCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = AllusersCollectionThymeleafController.class)
public class AllusersCollectionThymeleafLinkFactory implements MethodLinkFactory<AllusersCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<AllusersCollectionThymeleafController> getControllerClass() {
        return AllusersCollectionThymeleafController.class;
    }
