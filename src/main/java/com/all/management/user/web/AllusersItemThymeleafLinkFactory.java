...
@Component
/**
 * = AllusersItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = AllusersItemThymeleafController.class)
public class AllusersItemThymeleafLinkFactory implements MethodLinkFactory<AllusersItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<AllusersItemThymeleafController> getControllerClass() {
        return AllusersItemThymeleafController.class;
    }
